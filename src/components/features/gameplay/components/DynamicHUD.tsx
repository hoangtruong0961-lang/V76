            ...
            <div className="px-4 py-3 flex items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-3 group cursor-pointer shrink-0 rounded-2xl hover:bg-black/10 dark:hover:bg-white/5 p-1.5 -ml-1 transition-all"
                        id="hud_avatar_btn"
                    >
                        ...
                        <div className="flex flex-col items-start leading-tight">
                            <span className="text-xs font-black group-hover:text-mystic-accent transition-colors tracking-widest uppercase font-mono" style={{ color: s.text }}>
                                {worldData.player.name}
                            </span>
                            <span className="text-[10px] font-bold max-w-[130px] md:max-w-[210px] truncate flex items-center gap-1.5 mt-0.5" style={{ color: s.textMuted }}>
                    ...
                    <div className="h-8 w-px hidden md:block" style={{ backgroundColor: s.borderMuted }} />
                    ...
                    <div className="flex items-center gap-2.5 overflow-x-auto select-none no-scrollbar flex-1 pb-1 md:pb-0" id="hud_widgets_container">
                        ...
                        {visibleWidgets.includes('env') && (
                            <div className="flex items-center gap-1.5 px-3 py-2 rounded-xl border-none shrink-0" style={{ backgroundColor: s.badgeBg, color: s.text }}>
                                {environmentTheme.timeIcon}
                                <span className="text-[10px] font-extrabold font-mono" style={{ color: s.text }}>{environmentTheme.timeStr}</span>
                                <span className="text-[10px] font-normal font-mono" style={{ color: s.textMuted }}>|</span>
                                {environmentTheme.sceneryIcon}
                                <span className="text-[10px] font-extrabold truncate max-w-[100px] md:max-w-[150px]" style={{ color: s.text }}>{locationString}</span>
                            </div>
                        )}

                        {/* 2. Primary Vitals Indicator Bar */}
                        {visibleWidgets.includes('stats') && healthStat && (
                            <div className="hidden sm:flex flex-col gap-1 w-24 md:w-32 shrink-0 border-none px-2.5 py-1.5 rounded-xl justify-center" style={{ backgroundColor: s.badgeBg }}>
                                <div className="flex justify-between text-[8px] font-mono font-black leading-none" style={{ color: s.textMuted }}>
                        ...
                        {visibleWidgets.includes('stats') && manaStat && (
                            <div className="hidden md:flex flex-col gap-1 w-20 md:w-28 shrink-0 border-none px-2.5 py-1.5 rounded-xl justify-center" style={{ backgroundColor: s.badgeBg }}>
                                <div className="flex justify-between text-[8px] font-mono font-black leading-none" style={{ color: s.textMuted }}>
                        ...
                        {visibleWidgets.includes('quest') && (activeQuest || currentObjective) && (
                            <div className="hidden lg:flex items-center gap-1.5 px-3 py-2 rounded-xl border-none shrink-0 animate-fadeIn" style={{ backgroundColor: s.badgeBg }}>
                                <Target size={11} className="text-amber-500 animate-pulse" />
                                <span className="text-[10px] font-extrabold truncate max-w-[150px] md:max-w-[220px]" style={{ color: s.text }}>
                        ...
                        {visibleWidgets.includes('economy') && economy.length > 0 && (
                            <div className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-xl border-none shrink-0 font-mono" style={{ backgroundColor: s.badgeBg }}>
                        ...
                        {visibleWidgets.includes('effects') && activeEffects.length > 0 && (
                            <div className="flex items-center gap-1 px-2.5 py-1.5 rounded-xl shrink-0 text-[10px] font-bold border" style={{ backgroundColor: s.badgeBg, borderColor: s.badgeBorder, color: s.accent }}>
                        ...
                        {customWidgets.map(widget => {
                            ...
                            return (
                                <div 
                                    key={widget.id} 
                                    className="flex items-center gap-1.5 px-3 py-2 rounded-xl border-none shrink-0"
                                    style={{ backgroundColor: s.badgeBg }}
                                    title={`Tùy chỉnh: ${widget.label}`}
                                >
                                    <span className="text-xs leading-none">{widget.iconEmoji}</span>
                                    <span className="text-[10px] font-medium font-mono uppercase" style={{ color: s.textMuted }}>{widget.label}:</span>
                                    <span className="text-[10px] font-black font-mono" style={{ color: s.text }}>{customVal}</span>
                                </div>
                            );
                        })}
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                    <button 
                         ...
                         className={`px-3.5 py-2.5 rounded-xl border-none flex items-center gap-2 text-[11px] font-mono tracking-widest uppercase transition-all duration-300 hover:scale-105 active:scale-95 neu-btn ${
                    ...
                    <button 
                         ...
                         className="p-2.5 rounded-xl border-none flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 neu-btn"
                         style={{ color: s.text }}
                ...
                {expanded && (
                    ...
                    >
                        <div className="flex flex-col h-full max-h-[75vh] md:max-h-[500px]">
                            ...
                            {/* Tab Selection Row */}
                            <div className="flex px-4 pt-1 gap-1 overflow-x-auto no-scrollbar border-b bg-black/10 dark:bg-black/40" style={{ borderColor: s.borderMuted }}>
                                {[
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-1.5 px-4 py-3 text-[10px] font-bold uppercase tracking-wider rounded-t-xl transition-all border-b-2 whitespace-nowrap cursor-pointer"
                                        style={{
                                            color: activeTab === tab.id ? s.text : s.textMuted,
                                            borderBottomColor: activeTab === tab.id ? s.accent : 'transparent',
                                            backgroundColor: activeTab === tab.id ? s.accent + '10' : 'transparent',
                                        }}
                                    >
                                        {tab.icon}
                                        <span>{tab.label}</span>
                            ...
                            <div className="p-4 overflow-y-auto custom-scrollbar flex-1" style={{ backgroundColor: s.bg }}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <div className="rounded-xl border p-3 space-y-3" style={subCardStyle}>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <div className="rounded-xl border p-2 max-h-[220px] overflow-y-auto no-scrollbar shadow-sm" style={subCardStyle}>
                                                    {skills.length > 0 ? (
                                                        skills.map((s, i) => (
                                            ...
                                            {companions.length > 0 && (
                                                <div>
                                                    ...
                                                    <div className="rounded-xl border p-2 grid grid-cols-1 gap-2 shadow-sm" style={subCardStyle}>
                                                        {companions.map((c, i) => (
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <div className="rounded-xl border p-3 space-y-2 max-h-[220px] overflow-y-auto no-scrollbar shadow-sm" style={subCardStyle}>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 animate-fadeIn">
                                        ...
                                        <div className="lg:col-span-5 flex flex-col justify-between space-y-4">
                                            <div>
                                                ...
                                                <div className="rounded-xl border p-4 flex flex-col items-center relative min-h-[220px] justify-center" style={subCardStyle}>
                                                    ...
                                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 w-full max-w-sm">
                                                        {silhouetteSlots.map(slot => {
                                                            ...
                                                            return (
                                                                <div 
                                                                    key={slot.key} style={{ backgroundColor: eqItem ? s.accent + '25': s.card, borderColor: eqItem ? s.accent : s.borderMuted }} 
                                        ...
                                        <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
                                            <div>
                                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                                                    ...
                                                    <input 
                                                        ...
                                                        className="px-2 py-0.5 text-[10px] rounded border outline-none w-full sm:w-36 focus:border-sky-500 transition-colors font-mono"
                                                        style={inputStyle}
                                                    />
                                                </div>
                                                
                                                {/* Squares layout of items */}
                                                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2.5 max-h-[220px] overflow-y-auto no-scrollbar rounded-xl border p-2" style={subCardStyle}>
                                                    {filteredItems.length > 0 ? (
                                                        filteredItems.map((item, i) => (
                                                            <div 
                                                                ...
                                                                style={{
                                                                    backgroundColor: selectedItem?.name === item.name ? s.accent + '25' : s.card,
                                                                    borderColor: selectedItem?.name === item.name ? s.accent : s.borderMuted
                                                                }}
                                            ...
                                            {selectedItem && (
                                                <motion.div 
                                                    ...
                                                    className="p-3 rounded-xl border flex flex-col relative" style={{ backgroundColor: s.badgeBg, borderColor: s.borderMuted, color: s.text }}
                                                >
                                                    <button 
                                            ...
                                            {economy.length > 0 && (
                                                <div className="rounded-xl border p-2 px-3 flex flex-wrap gap-3 items-center shadow-sm" style={subCardStyle}>
                                            ...
                                            <div className="space-y-2.5 max-h-[300px] overflow-y-auto no-scrollbar">
                                                {quests.length > 0 ? (
                                                    quests.map((q, i) => {
                                                        ...
                                                        return (
                                                            <div 
                                                                key={i} style={{ backgroundColor: isActive ? (s.accent === '#f59e0b' ? 'rgba(245,158,11,0.1)' : s.badgeBg) : isDone ? 'rgba(16,185,129,0.1)' : s.card, borderColor: isActive ? '#f59e0b' : isDone ? '#10b981' : s.borderMuted }} 
                                                            ...
                                                            >
                                                                ...
                                                                <div className="text-[12px] font-bold mt-2 font-mono" style={{ color: s.text }}>{q.name}</div>
                                                                
                                                                {q.progress && (
                                                                    <div className="mt-2 flex flex-col gap-0.5 p-2 rounded border" style={{ backgroundColor: s.bg, borderColor: s.borderMuted }}>
                                                                        <span className="text-[9px] font-bold uppercase tracking-wider font-mono" style={{ color: s.textMuted }}>Tiến độ sự kiện</span>
                                                                        <span className="text-[11px] italic leading-snug" style={{ color: s.text }}>{q.progress}</span>
                                                                    </div>
                                                                )}
                                                            </div>
                                                        );
                                        ...
                                        <div className="lg:col-span-5 space-y-4">
                                            ...
                                            {places.length > 0 && (
                                                <div>
                                                    ...
                                                    <div className="rounded-xl border p-2 grid grid-cols-1 gap-2 max-h-[140px] overflow-y-auto no-scrollbar shadow-sm" style={subCardStyle}>
                                                        {places.map((p, i) => (
                                                            <div key={i} className="py-2 px-2.5 rounded border flex flex-col" style={{ backgroundColor: s.bg, borderColor: s.borderMuted }}>
                                                                <span className="text-[11px] font-bold font-mono" style={{ color: s.text }}>{p.name}</span>
                                            ...
                                            {rumors.length > 0 && (
                                                <div>
                                                    ...
                                                    <div className="rounded-xl border p-2.5 space-y-2 max-h-[150px] overflow-y-auto no-scrollbar shadow-sm" style={subCardStyle}>
                                                        {rumors.map((rum, i) => (
                                                            <div key={i} className="text-[10px] leading-relaxed p-2 border rounded" style={{ backgroundColor: s.bg, borderColor: s.borderMuted, color: s.text }}>
                                        ...
                                        {factions.length > 0 && (
                                            <div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2.5">
                                                    {factions.map((f, i) => (
                                                        <div key={i} className="p-2.5 rounded-xl border flex items-center justify-between" style={subCardStyle}>
                                                            <div className="flex flex-col min-w-0">
                                                                <span className="text-[12px] font-bold truncate font-mono" style={{ color: s.text }}>{f.name}</span>
                                                                <span className="text-[10px] mt-0.5 leading-none" style={{ color: s.textMuted }}>Ngoại giao: {f.diplomacy || 'Hòa hoãn'}</span>
                                                            </div>
                                                            <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: s.bg, borderColor: s.borderMuted, color: s.text }}>
                                                                🛡️ {f.reputation || '0'}
                                                            </span>
                                                        </div>
                                                    ))}
                                                ...
                                                {relations.length > 0 ? (
                                                    relations.map((rel, i) => {
                                                        ...
                                                        return (
                                                            <div 
                                                                key={i} 
                                                                className="p-3 rounded-xl border transition-colors flex gap-3 shadow-sm" style={{ backgroundColor: s.card, borderColor: isActiveRecently ? '#ec4899' : s.borderMuted }}
                                                            >
                                                                {/* Circular Avatar */}
                                                                <div className="relative shrink-0">
                                                                    <div className="w-10 h-10 rounded-full flex items-center justify-center border" style={{ backgroundColor: s.bg, borderColor: isActiveRecently ? '#ec4899' : s.borderMuted }}>
                                                                ...
                                                                <div className="flex flex-col flex-1 min-w-0">
                                                                    <div className="flex items-center justify-between gap-1.5">
                                                                        <span className="text-[12px] font-black truncate font-mono" style={{ color: s.text }}>{rel.name}</span>
                                                                        <span className="text-[10px] font-mono px-2 rounded-full whitespace-nowrap border" style={{ backgroundColor: s.bg, borderColor: s.borderMuted, color: s.text }}>
                                                                            💖 {rel.affinity}
                                                                        </span>
                                                                    </div>
                                                                    ...
                                                                    <p className="text-[10px] mt-2 line-clamp-2 leading-relaxed font-sans" style={{ color: s.textMuted }}>
                                                                        {rel.desc}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                ...
                                                {playerTimeline.length > 0 ? (
                                                    playerTimeline.map((item, i) => (
                                                        <div key={i} className="relative group">
                                                            ...
                                                            <div className="rounded-xl border p-3 transition-colors shadow-sm" style={subCardStyle}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-5 animate-fadeIn" id="hud_config_panel">
                                        ...
                                        <div className="md:col-span-6 space-y-4">
                                            <div>
                                                ...
                                                <div className="rounded-xl border p-3 space-y-2" style={subCardStyle}>
                                                    {[
                                                        ...
                                                        <div 
                                                            key={orig.id} style={{ backgroundColor: visibleWidgets.includes(orig.id) ? s.accent + '20' : s.card, borderColor: visibleWidgets.includes(orig.id) ? s.accent : s.borderMuted, color: s.text }} 
                                        ...
                                        <div className="md:col-span-6 space-y-4">
                                            <div>
                                                ...
                                                <div className="rounded-xl border p-4 space-y-3.5" style={subCardStyle}>
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        ...
                                                        <input 
                                                            ...
                                                            className="px-3 py-2 text-xs rounded-lg border outline-none focus:border-emerald-500 transition-colors font-mono"
                                                             style={inputStyle}
                                                        />
                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3">
                                                        ...
                                                        <div className="flex flex-col gap-1">
                                                            ...
                                                            <select 
                                                                value={newWidgetTable} style={inputStyle} 
                                                        ...
                                                        <div className="flex flex-col gap-1">
                                                            ...
                                                            <select 
                                                                value={newWidgetEmoji} style={inputStyle} 
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3">
                                                        ...
                                                        <div className="flex flex-col gap-1">
                                                            ...
                                                            <input 
                                                                ...
                                                                min="0"
                                                                max="20"
                                                                value={newWidgetRow} style={inputStyle}
                                                        ...
                                                        <div className="flex flex-col gap-1">
                                                            ...
                                                            <input 
                                                                ...
                                                                min="0"
                                                                max="8"
                                                                value={newWidgetCol} style={inputStyle}
                                                    ...
                                                    <div className="p-3 rounded-xl border space-y-2.5 animate-fadeIn" style={{ backgroundColor: s.bg, borderColor: s.borderMuted }}>
                                                        <div className="flex items-center justify-between">
                                                        ...
                                                        {/* Preview Cells Grid */}
                                                        <div className="rounded border max-h-[120px] overflow-y-auto custom-scrollbar p-2 space-y-2" style={{ backgroundColor: s.bg, borderColor: s.borderMuted }}>
                                                            {(() => {
                                            ...
                                            {customWidgets.length > 0 && (
                                                <div>
                                                    ...
                                                    <div className="rounded-xl border p-2 space-y-1.5" style={subCardStyle}>
                                                        {customWidgets.map(widget => (
                                                            <div key={widget.id} className="p-2 border rounded-lg flex items-center justify-between" style={{ backgroundColor: s.bg, borderColor: s.borderMuted }}>
