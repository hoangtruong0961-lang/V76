...
export interface AppSettings {
  ...
  _deepLogicMigratedToAdvisory?: boolean;
...
export interface ChatMessage {
  ...
  text: string;
  thinking?: string; // Isolated thinking/reasoning text
  timestamp: number;
  ...
  lsrData?: Record<string, unknown[]>; // LSR state snapshot after this turn/message
  swipesLsrData?: Record<string, unknown[]>[]; // LSR state snapshot for each swipe variation
  // New fields for Swipe/Regenerate
  swipes?: string[]; // Array of message variations
  swipesThinking?: string[]; // Array of thinking variations for each swipe
